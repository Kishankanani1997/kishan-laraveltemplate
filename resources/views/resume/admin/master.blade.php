...
<head>
    <title>Admin Panel Laravel Template | @yield('title-name')</title>
    <!-- Meta Tags -->
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="/Card-Page">Cards</a>
                        </li>
                        <li>
                            <a href="/Carousel-Page">Carousels</a>
                        </li>
                        <li>
                            <a href="/Form-Page">Forms</a>
                        </li>
                        <li>
                            <a href="/Modal-Page">Modals</a>
                        </li>
                        <li>
                            <a href="/Table-Page">Tables</a>
                        </li>
                    </ul>
                </li>
                <li>
                            ...
                            <div class="dropdown-menu top-grid-scroll drop-1">
                                ...
                                <a href="#" class="dropdown-item mt-3">
                                    <div class="notif-img-agileinfo">
                                        <img src="{{('admin/images/clone.jpg')}}" class="img-fluid" alt="Responsive image">
                                    </div>
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    <div class="profile-l align-self-center">
                                        <img src="{{('admin/images/profile.jpg')}}" class="img-fluid mb-3" alt="Responsive image">
                                    </div>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/Login-Page">Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
...
@yield('content');
    ...
    <!-- Count-down -->
    <script src="{{('admin/js/simplyCountdown.js')}}"></script>
    <link href="{{('admin/css/simplyCountdown.css')}}" rel='stylesheet' type='text/css' />
    <script>
        var d = new Date();
