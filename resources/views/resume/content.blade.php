   ...
   @section('Content')
    ...
    <section class="w3l-banner py-5" id="home">
        <div class="container py-md-5 py-4">
            <div class="row align-items-center pt-4">
                <div class="col-md-6 banner-left pe-xl-5">
                    <h4 class="text-info">Hi, I'm Kishan Patel</h4>
                    <h3 class="mb-3 mt-1 text-info">Developer</h3>
                    <p class="banner-sub me-md-5 text-info">I love to work as Backend Developer.</p>
        ...
        <div class="icon-effects-w3-1 text-right">
            <img src="{{asset('resume/images/icon2.png')}}" alt="" class="img-fluid">
        </div>
        <div class="icon-effects-w3-2 text-right">
            <img src="{{asset('resume/images/icon3.png')}}" alt="" class="img-fluid">
        </div>
        <div class="icon-effects-w3-3 text-right">
            <img src="{{asset('resume/images/icon1.png')}}" alt="" class="img-fluid">
        </div>
        <div class="icon-effects-w3-4 text-right">
            <img src="{{asset('resume/images/icon6.png')}}" alt="" class="img-fluid">
        </div>
        <!-- //animations icons -->
    </section>
    <!-- //banner section -->
            ...
            <div class="company-logos text-center">
                <div class="row mx-auto justify-content-center">
                    <div class="col-md-2 col-sm-4 col-6 ">
                        <img src="{{asset('resume/images/logo1.png')}}" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-2 col-sm-4 col-6">
                        <img src="{{asset('resume/images/logo2.png')}}" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-2 col-sm-4 col-6 mt-sm-0 mt-3">
                        <img src="{{asset('resume/images/logo3.png')}}" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-2 col-sm-4 col-6 mt-md-0 mt-3">
                        <img src="{{asset('resume/images/logo4.png')}}" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-2 col-sm-4 col-6 mt-md-0 mt-3">
                        <img src="{{asset('resume/images/logo5.png')}}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="position-relative">
                        <img src="{{asset('resume/images/kishan2.jpg')}}" alt="" class="radius-image img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 ps-lg-5 mt-lg-0 mt-5">
                    ...
                    <div class="my-info mt-md-5 mt-4">
                        ...
                        <ul class="single-info">
                            ...
                            <li>:</li>
                            <li>
                                <p><a href="mailto:maryateer@mail.com">info@kishan.com</a></p>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-lg-0 mt-4">
                    ...
                    <div class="timeline">
                        <div class="column">
                            <div class="title">
                                <h2>Trainee PHP Backend Developer </h2>
                            </div>
                            <div class="description">
                                <p>Tops Technology</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 item">
                    <a href="assets/images/g1.jpg" data-lightbox="example-set" data-title="Project 1"
                        class="zoom d-block">
                        <img class="card-img-bottom d-block" src="{{asset('resume/images/g1.jpg')}}" alt="Card image cap">
                ...
                <div class="col-lg-4 col-md-6 item mt-md-0 mt-4">
                    <a href="assets/images/g2.jpg" data-lightbox="example-set" data-title="Project 2"
                        class="zoom d-block">
                        <img class="card-img-bottom d-block" src="{{asset('resume/images/g2.jpg')}}" alt="Card image cap">
                        <span class="overlay__hover"></span>
                        <span class="hover-content">
                ...
                <div class="col-lg-4 col-md-6 item mt-lg-0 mt-4">
                    <a href="assets/images/g3.jpg" data-lightbox="example-set" data-title="Project 3"
                        class="zoom d-block">
                        <img class="card-img-bottom d-block" src="{{asset('resume/images/g3.jpg')}}" alt="Card image cap">
                        <span class="overlay__hover"></span>
                        <span class="hover-content">
                ...
                <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                    <a href="{{asset('resume/images/g5.jpg')}}" data-lightbox="example-set" data-title="Project 4"
                        class="zoom d-block">
                        <img class="card-img-bottom d-block" src="{{asset('resume/images/g5.jpg')}}" alt="Card image cap">
                        <span class="overlay__hover"></span>
                        <span class="hover-content">
                ...
                <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                    <a href="assets/images/g6.jpg" data-lightbox="example-set" data-title="Project 5"
                        class="zoom d-block">
                        <img class="card-img-bottom d-block" src="{{asset('resume/images/g6.jpg')}}" alt="Card image cap">
                        <span class="overlay__hover"></span>
                        <span class="hover-content">
                ...
                <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                    <a href="assets/images/g4.jpg" data-lightbox="example-set" data-title="Project 6"
                        class="zoom d-block">
                        <img class="card-img-bottom d-block" src="{{asset('resume/images/g4.jpg')}}" alt="Card image cap">
                        <span class="overlay__hover"></span>
                        <span class="hover-content">
                    ...
                    <div class="owl-two owl-carousel owl-theme">
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                <div class="message">
                                    <img src="{{asset('resume/images/quote.png')}}" alt="" class="img-fluid mb-2" />
                                ...
                                <div class="img-circle">
                                    <img src="{{asset('resume/images/c1.jpg')}}" class="img-fluid radius-image" alt="client">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="img-circle">
                                    <img src="{{asset('resume/images/c2.jpg')}}" class="img-fluid radius-image" alt="client">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="img-circle">
                                    <img src="{{asset('resume/images/c3.jpg')}}" class="img-fluid radius-image" alt="client">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="img-circle">
                                    <img src="{{asset('resume/images/c4.jpg')}}" class="img-fluid radius-image" alt="client">
                                </div>
                            </div>
                        </div>
                    </div>
